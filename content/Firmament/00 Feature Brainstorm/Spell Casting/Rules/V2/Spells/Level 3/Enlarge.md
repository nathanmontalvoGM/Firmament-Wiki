...
**Empower (3):** Increase the size of the creature by one more size category (maximum of gargantuan). For every size category above large, increase the melee weapon damage bonus by +2 and the weapon reach by 5 feet.