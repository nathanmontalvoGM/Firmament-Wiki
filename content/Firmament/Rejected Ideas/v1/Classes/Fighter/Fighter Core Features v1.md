...
- If you do not use a maneuver during an opening, then the opening is lost.

Different disciplines allow for different openings to be exploited but all fighters can exploit the following openings in an enemy.
