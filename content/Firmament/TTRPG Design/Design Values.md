...
- Selecting feats that **modify core class abilities** (e.g., turn a simple strike into a cleave, or add elemental damage riders).
- Combining feat choices with ancestry, background, and class features to create **distinct mechanical builds**.

**Result:**  
Two characters of the same class play completely differently in combat and exploration.
...
- Reading the description of an ability and asking “How else can I apply this?”  
- Watching the battlefield for **terrain advantages**, hazards, chokepoints, and environmental tools.
- Spending actions creatively (movement, jumping, shoving, interacting).
- Leveraging the GM’s narrative prompts (“The chandelier swings overhead…”) to improvise.
- Using **Favored/Hindered** to push high-risk, high-reward plays.

**Result:**  
Abilities become flexible tools rather than rigid routines.
...
- **Action economy choices** (spend 1, 2, or 3 actions for different versions of the same ability).
- **Critical effects** that transform basic actions into dramatic moments
- **Upcasting** or empowerment mechanics that expand the radius, damage, or potency of an ability.
- Choosing feats that **alter the baseline use** of an existing feature.
