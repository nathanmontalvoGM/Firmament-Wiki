...
Full Legal Information [HERE](https://creativecommons.org/licenses/by-nc-sa/2.5/).
...
![][image2]*Slide source: [Chris Wilson at GDC 2019](https://www.youtube.com/watch?v=pM_5S55jUzk)*
...
2. No idea will be for everyone as people have different and conflicting desires.  
3. Will it be for someone? At least you, that's for sure. The goal isn't to make something popular, it's to make something good, and then let the community build around that.  
...
Practical tools can help. Create vision boards ([Pinterest](https://www.pinterest.com/)), jot down notes as if writing adventures, or use platforms like [World Anvil](https://www.worldanvil.com/) for worldbuilding prompts. Even simple exercises like searching for writing prompts online can spark ideas and help refine your setting. If you’d like more insight into world building I’d suggest [this video](https://www.youtube.com/watch?v=u1J8nul74BM) as a good start.

![][image3]![][image4]![][image5]*Popular Generic System Cover Art*
...
* Estimates are based on:  
  ...
  * Data Reporting from Market Reporting Outlets:   
    * [Source 1](https://www.globalgrowthinsights.com/market-reports/tabletop-role-playing-game-ttrpg-market-103239)  
    * [Source 2](https://www.econmarketresearch.com/industry-report/tabletop-role-playing-game-ttrpg-market/)  
...
5\) Always consider what player behavior the rule encourages and compare/contrast to the intended play experience.  I’d strongly recommend reviewing [Manyfold](https://levikornelsen.itch.io/manyfold) for basic ideas on how to support and craft different mechanics for different kinds of player motivations/game loops.
...
After independently developing this it was pointed out that all 10 of these loosely align with the [Norman/Nielsen 10 usability heuristics](https://www.nngroup.com/articles/ten-usability-heuristics/) (for interface design), though are made relevant in the context of TTRPG design.
...
Example from David Garrett, [This Mortal Coil](https://amalara.com/products/this-mortal-coil):
...
*If you dig necromancers, space, necromancers-in-space, creepy monsters, and lots of undead, you can find the beta here: [This Mortal Coil](https://carpedavid.itch.io/this-mortal-coil).*
...
None of this needs to follow the traditional PC/GM structure, dungeon fantasy, or dice rolling. Some games have no GM at all. Some are solo-only. Characters can be hackers, gods, kittens, or microbes. Worlds can be contained to a single city or  sprawling multiverses, or even both simultaneously: see [*Planescape*](https://www.drivethrurpg.com/en/product/17267/planescape-campaign-setting-2e). Your engine could rely on dice, cards, coins, dominoes, bidding, or any other tool that produces random or semi-random results. What matters is that results are clear and meaningful within your game’s rules.
...
For even more info on various common decision engines head [here](https://www.youtube.com/watch?v=E-6-Xk2dGTw), and keep in mind the opinions of the author are opinions, and really any of these or variations can be modified drastically for better and worse by the surrounding rules ecosystem.
...
Article [HERE](https://www.engadget.com/ai/it-turns-out-you-can-train-ai-models-without-copyrighted-material-174016619.html)  followed by research white paper [HERE](https://github.com/r-three/common-pile/blob/main/paper.pdf).

This common misconception is mostly rooted in:

* Ignorance of people that don’t use and refuse to learn about AI models.  
* An intentional lie from the big tech companies.  They specifically made arguments early on that they “HAD TO” do this (train on scraped data), but they didn’t (as shown in the papers above, the performance of that model exceeds all early models). The reason they “had to” was to be first to market to gobble up all money and sell AI as hype. This proved massively effective once they and other big companies realized the data harvesting potential of putting AI into literally everything (this is largely why AI is clumsily shoe-horned in practically every digital product now).

If you’d like to use models that are only trained on public data and publicly donated data:

LLMs (large language models): Here's [4 right away](https://www.llm360.ai/) that have research white papers support.  
Here's a [15TB DB training set](https://huggingface.co/datasets/HuggingFaceFW/fineweb) to make your own from scratch if you’re at all code capable (almost twice as big as the one used in the 8TB paper).  
...
Shortcut part 1: If you want a definitive short list to start with I’d recommend: Blades in the Dark, Mothership, GURPS, DnD 4e.  Why? Check out [this video](https://www.youtube.com/watch?v=R8kXQDc0N8Y&t=2s&ab_channel=TalesfromElsewhere) which I largely tend to agree with.  I will add my own honorable mention onto this list of BRP as an essential tool for all new system designers  (I know I recommended it to people who don’t want to build a system above), not because it’s special and wonderful, but because as a toolkit to build a system and can give you lots of things to think about and modular ways to incorporate systems you may not be aware of if you have minimal system design experience. The only places it really falls short is with Cybernetics/Bionics and highly specialized equipment (for games that really want gear focussed characters) to give you a really solid foundation of the kinds of systems you might want to include, and various ways you might go about implementing them. 

Shortcut part 2: OK you did the entry level stuff, how about some more advanced considerations? Next check out: PF2e, Mork Borg, RoleMaster, Apocalypse World, And “Weird Stuff” with my personal recommends of these being: [Everyone is John](https://www.dropbox.com/scl/fi/o4nx2ggqx6vsu273bizmp/EveryoneIsJohnSheet3.pdf?rlkey=25a9vmmnv3t5krhfer3gzstfe&e=1&dl=0) (3 pages, or you can use the [original 1 page version](https://imgur.com/a/eij-l51P3#0)), and [Brindlewood Bay](https://www.gauntlet-rpg.com/brindlewood-bay.html) (168 pages). Why? You guessed it, [Video Link](https://www.youtube.com/watch?v=tk5CGh9SJEY&t=36s&ab_channel=TalesfromElsewhere).

[*Dungeons and Dragons 1st edition*](https://www.amazon.com/Players-Handbook-Advanced-Dungeons-Dragons/dp/0394511123) *(1974):*    
...
[*Call of Cthulhu*](https://www.chaosium.com/call-of-cthulhu-rpg/) *(1981):*  
...
[*GURPS*](http://www.sjgames.com/gurps/) *(1986):*   
...
[*Vampire: The Masquerade/WoD*](https://www.worldofdarkness.com/products/tabletop-games) *(1991):*   
...
[*Twilight 2000*](https://freeleaguepublishing.com/en/games/twilight-2000/) *(1991)*  
...
*The Forge (2001)*  
Unlike the other entries on this list, The Forge was not a game system but a now-defunct TTRPG design forum from the early 2000s. It operated as a TTRPG system design think tank, the only one of its kind at the time. This stood in contrast to something like [RPG Design](https://www.reddit.com/r/RPGdesign/) (a current resource I recommend), which functions more like a workshop. The key difference is that The Forge emphasized theory above all, while RPG Design emphasizes helping creators refine their own projects without pushing it through a unified theoretical lens that may not be suiting.  
Many notable designers emerged from The Forge, and two major design theories came out of it: GNS and the Big Model. I will not go into heavy detail here because these frameworks are not especially relevant to the modern design space, save among a small handful of designers who still insist on them. They can be useful tools in very narrow situations, but they are deeply flawed and have been debunked in various ways by countless modern design examples that better explain the craft. If you want more depth, [William White’s book](https://link.springer.com/book/10.1007/978-3-030-52819-5) is a useful read.
...
[*Burning Wheel*](https://www.burningwheel.com/) *(2002)*  
...
[*Ars Magica 5e*](https://www.atlas-games.com/product_tables/AG0205) (2004)  
...
[*Dogs in the Vineyard*](https://en.wikipedia.org/wiki/Dogs_in_the_Vineyard) *(2004)*  
...
[*Apocalypse World and PbtA*](http://apocalypse-world.com/) *(2010)*  
...
[*Savage Worlds*](https://peginc.com/savage-settings/savage-worlds/) *(2012)*  
...
[*Lasers and Feelings*](https://johnharper.itch.io/lasers-feelings) (2013)  
...
[*Dungeons and Dragons 5e*](https://dnd.wizards.com/products?category=where-to-start) *(2014)*  
...
[*Blades in the Dark*](https://evilhat.com/product/blades-in-the-dark/) *(2017)*  
...
[*City of Mist*](https://cityofmist.co/) *(2017)*  
...
[*Index Card RPG*](https://www.modiphius.net/en-us/products/index-card-rpg-master-edition) *(2018)*  
...
[*Mothership*](https://www.mothershiprpg.com/) *(2018)*  
...
[*Pathfinder 2e*](https://paizo.com/pathfinder) *(2019)*  
...
[*Shadowdark*](https://www.thearcanelibrary.com/pages/shadowdark) *(2024)*  
...
* **Further Reading:** [*The Praxic Compendium*](https://levikornelsen.itch.io/praxic-compendium) is one of the best resources for studying a wide spread of design conventions. It isn’t exhaustive (nothing can be), but being aware of its catalog will expand your design toolkit.
...
*Example:*   
![][image8]*Source: Ted Hayes [Sentients](https://www.sentientsrpg.com/)*
...
* **Tools:** [InDesign](https://www.adobe.com/products/indesign.html) is industry standard; [Affinity](https://affinity.serif.com/en-us/publisher/?srsltid=AfmBOopAJZnf9VERA_tqV7v7Oq-ekV-HPUJ7svF4_chRT3q1HM0sl6a4) is a solid budget alternative with frequent deep cut sales approximately 2x yearly. If budget is a concern, write in a document program of choice and wait for affinity to go on sale.  
...
* **Basic UX Book Org: (prescriptive use)**

1\. Set the Hook (Forward & Primer)

* Introduce *why* players should care and *what* makes your game worth their time.  
* Keep this narrative and engaging. Avoid bullets unless conveying marketing-style highlights.  
* Frame tone, genre, stakes, core identity, and game loop clearly (and briefly).  
* If you don’t have a style guide you should consider one at this stage for consistent tonal and visual cues by section.

2\. Define Terms Before Use

* Never assume familiarity. Introduce terminology before it appears in the rules.  
* Flag terms for glossary inclusion from the outset. Consider cross-referencing terms throughout chapters.  
* Think: clarity first, flavor second (function over form).

3\. Open Each Section with Context

* Every major chapter/subsection should start with 1–2 sentences explaining:  
  * *What* the reader is about to learn.  
  * *Why* it matters to the experience or play.

4\. Present Only What They Need (When They Need It)

* Sequence rules and content based on how urgently it needs to be learned to play.  
* Early chapters \= fast start. Prioritize table-read usability.  
* Reference deeper material *without* full digressions (e.g., “see p. XX for full mechanics”).

5\. Use the Right Formatting Tool for the Right Information

* Default to bullets for clarity, especially in body rule text.  
* Use templates, tables, flowcharts, and numbered lists where they aid digestion.  
* For smaller (micro or less) games, you *can* flex format to be more conversational, but clarity is never optional.

6\. Use Lore Sparingly in Rules Sections

* In core rule explanations, include *only* essential in-world flavor to support function.  
* Save broader lore/worldbuilding for later chapters or boxed sidebars.  
* Only use bullets for timelines or compressed setting facts.

7\. Handle Examples with Breakout Boxes

* Keep examples visually and structurally separate from core rules.  
* Use paragraph formatting inside the box if the example is complex.

8\. Break Up Density with Immersion

* Insert immersive in-world diegetic text between chapters (1–2 pages).  
* Follow with chapter title splash \+ artwork, then intro \+ mechanics.  
* If chapters are long or dense, include art between subsections to maintain pacing.  
* Immersive content *must* be thematically or mechanically relevant to avoid dissonance.

9\. Art Density & Placement

* Use your best quality and highest engagement piece that best explains the game on your cover.  
* Minimum art rate suggested: 1 piece per 4 two-page spreads.  
* Ideal (budget allowing): 1 piece per 1–2 two-page spreads.  
* For maximal style (e.g., X-Borg level), scale up to full-page overlays and abstract design flourishes.

10\. Quick-Reference Essentials

* If in-play reference fits in 2 or fewer 2-page spreads, place them inside covers (like *Shadowdark*).  
* If longer, compile into an appendix at the back (multiple, organized,  if needed).  
* Also consider *cheat sheets* or player aids as supplemental downloads.  
* The back cover should resemble your developed elevator pitch.
...
2. Be accessible at a glance.  
3. Reflect your game’s aesthetics.

Teach the game through layout.  
   
*Sheet source: [Autodesk Indestructables](https://www.instructables.com/Creating-a-DD-5e-Character-for-Beginners/)*
...
![][image13]  
*Sidebar navigation,* *Source: [Pathfinder 2e Advanced Player's Guide](https://paizo.com/products/btq022bc)*
...
* **Traditional route:** Pitch to publishers (they’ll take a cut, which varies with support offered). For a bit about pitching to indie online TTRPG retailers, see [this](https://www.technicalgrimoire.com/david/2022/11/jalopypitch) article.  
...
But VTT module development is expensive and usually out of reach for first-time indies. Some publishers (like SWADE) employ full-time VTT developers. Costs may drop as AI-assisted coding improves, or [HEDRON](https://www.projecthedron.com/) continues to mature, but it isn’t cheap yet.
...
If you’d like a mountain of resources, check out [this](https://thegiftofdice.itch.io/ttrpg-creator-resources-database) resource DB on itch.io

Lastly, the [RPG Design Reddit Wiki](https://www.reddit.com/r/RPGdesign/wiki/index/) also has a staggering amount of resources for your use and I’d strongly recommend that community. This is specifically where I learned about half of what was covered above.

For more information about my current development project, Project Chimera: E.C.O. (Enhanced Covert Operations) TTRPG please visit us on [Facebook](https://www.facebook.com/groups/1993142787742991) / [Reddit](https://www.reddit.com/r/ProjectChimeraTTRPG/) or check out the [Facebook Media Page](https://www.facebook.com/groups/1993142787742991/permalink/1993259081064695) for a general overview.

If you found this article useful/helpful and would like to support me personally you can [buy me a coffee](https://www.buymeacoffee.com/klokkaos). I do not presently have a patreon or active youtube account but those are in the works when the time is right.
