...
- [ ] Level 2 — Define level 2 feat options (damage, defense, utility) [priority:: important] [class:: Bard]
- [ ] Level 3 — Define class feature [priority:: important] [class:: Bard]
- [ ] Level 4 — Define class feature [priority:: important] [class:: Bard]
- [ ] Level 5 — Define class feature [priority:: important] [class:: Bard] [notes:: Level 5 is a key power spike in most systems]
- [ ] Level 6 — Define class feature [priority:: important] [class:: Bard]
- [ ] Level 7 — Define class feature [priority:: important] [class:: Bard]
...
- [ ] Define if Bard gets unique skill-related class features [priority:: important] [class:: Bard] [notes:: Jack of All Trades equivalent?]
- [ ] Decide if Bard can upgrade skill proficiencies beyond other classes [priority:: important] [class:: Bard]
- [ ] Define any out-of-combat utility features [priority:: optional] [class:: Bard]

### Playtesting & Balance

- [ ] Compare Bard damage output to Fighter at levels 1, 5, 10 [priority:: optional] [class:: Bard]
- [ ] Verify Inspiration doesn't overshadow other support options [priority:: optional] [class:: Bard]
- [ ] Verify Mana costs feel appropriate for Bard spell list [priority:: optional] [class:: Bard]
- [ ] Playtest Bard in a 4-player party [priority:: optional] [class:: Bard]