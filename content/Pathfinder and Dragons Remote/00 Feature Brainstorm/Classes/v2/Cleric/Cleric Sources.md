...
Will still 
### Terminology 
* #Ritual: spells with this tag can only use sources with the ritual tag,
### Core Class Features to Modify
#### Channel Divinity
#### Favored Weapon 
### Current feats
#### Life Domain
Can probably move some of these out of here. Sort by level for these feats

Want 5 options per level for a decent amount of variety. 
##### Life - (Level 2)
...
- **Master:**  +5 AC, the effect now persists for 2 attacks instead of 1.

##### Persistence - (Level 6+)
Twice per scene, when this feat affects a creature, you may extend its Duration by a number of rounds determined by your training in this feat. This source has no effect on feats with no listed duration.
...
##### Judgement - (Level 10)
Twice per scene, when this feat affects a creature, mark an enemy with a Mark of Judgment. The next ally to roll damage against that enemy applies an additional effect determined by your training in this feat.

- **Master:** deal an additional 10 radiant damage. Increase the die step of any damage dealing dice by one step (maximum of a d12). 
##### Zeal - (Level 10)
...
## Channel Divinity 
- **Prerequisite:** Feats that have the #ChannelDivinity tag.

## Favored Weapon 
- **Prerequisite:** Feats that have the #FavoredWeapon Tag
