...
**Trained:** gain a +4 bonus to melee attack rolls until the start of your next turn.  
**Expert:** gain a +15 movement speed bonus until the start of your next turn.
...
All weapon attacks until the start of your next turn gain the following effects:
**Trained:** deal an additional [[Weapon Dice|Weapon Die]] of damage on all weapon attacks and increase the die step by 1 (maximum of a d12). 
...
**Expert:** +4 bonus to attack rolls.
