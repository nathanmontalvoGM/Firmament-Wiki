...
<div class="hub-grid">
  ...
  <a class="hub-card Barbarian" href="/update-this-path/Subclasses">
    <div class="hub-status">Incomplete, you can still view subclasses on the main Barbarian page</div>
