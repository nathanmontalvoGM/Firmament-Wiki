...
**Success:** The creature gains weakness to radiant damage equal to half your character level (rounded down) until the end of its next turn.
**Failure:** as success but the target takes 1d4 persistent radiant damage. 
**Critical Failure:** As failure, but the weakness is equal to your level.

**Empower (2):** the radiant weakness increases by +3
