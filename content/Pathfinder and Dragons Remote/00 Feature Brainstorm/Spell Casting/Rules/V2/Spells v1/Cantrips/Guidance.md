...
You call for divine blessing on a target you can see within range. Once before the spell ends, the target can roll a d4 and add the number rolled to any d20 roll of its choice. It can roll the die before or after making the ability check. The spell then ends and the creature is immune to its effects for 10 minutes.