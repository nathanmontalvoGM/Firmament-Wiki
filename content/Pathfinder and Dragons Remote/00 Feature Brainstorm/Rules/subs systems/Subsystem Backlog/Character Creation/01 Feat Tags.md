Instead of requiring certain feats as prerequisites for higher level feats, you instead must have a lower level feat with the same tag. If a feat lists multiple tags, it only counts as 1 of the two tags when considering a prerequisite for a feat. 
...
#Strike - alters or grants changes to weapons and attacks
#Steadfast - affects negatives to movement speed 
