...
* Reroll number
* Add extra die to added roll
* A flat bonus (mostly used for AC), should be used sparingly
* Treat results below X as X
* Extra Actions or Reduced Costs
* Crit Interaction Bonuses
* Positioning & State-Based Bonuses
	* Bonus damage when flanking
	* or a condition is applied (prone or slowed) 
* Probability Shaping
	* Ignore one failure
	* Trated as one result better
* Scaling Effects Instead of Scaling Numbers
	* Larger AoE
	* More targets
* Secondary effects
	* Splash damage
	* chain effects
	* status application (persistant damage or condition)
* Binary effects
	* Ignore cover
	* Ignore resistance
